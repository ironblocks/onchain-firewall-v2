...
library TaskDefinitionLibrary {
    ...
    function createNewTaskDefinition(
        ...
        string memory _name,
        TaskDefinitionParams calldata _params
        ...
        self.taskDefinitions[_id] = TaskDefinition(
            ...
            _params.restrictedOperatorIndexes
        );
    ...
    ) internal view returns (TaskDefinition storage) {
        return self.taskDefinitions[_taskDefinitionId];
    }

    function getMinimumVotingPower(
        TaskDefinitions storage self,
        uint16 _taskDefinitionId
    ...
    function getRestrictedOperatorIndexes(
        TaskDefinitions storage self,
        uint16 _taskDefinitionId
